...
<body>
    ...
    <div id="id01" class="modal" style="display: none;">
        <form class="modal-content animate" action="./crud/login.php" method="post">
    ...
    <div id="criar-usuario" class="criar-usuario" style="display: none;">
        <form action="./crud/inserirUsuario.php" method="post" class="criar-usuario">
            ...
            <input type="text" name="user-username" style="color: black;" value="">
