    ...
    <section>
        ...
        <div class="portal-display" style="display: block;">
            ...
            <div id="atualizar" class="cadcliente" style="display: none;">
                <form action="./crud/atualizarCliente.php" method="post">
            ...
            <div id="excluir" class="excluir" style="display: none;">
                ...
                <form action="./crud/excluirCliente.php" method="get" style="border: none; box-shadow: none; background-color: transparent;">
                    <input type="hidden" name="id_cliente" value="<?php echo $id_cliente ?>">
