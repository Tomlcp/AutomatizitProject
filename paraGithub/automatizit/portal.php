    ...
    <section>
        ...
        <div class="portal-display">
            <div id="home" class="home" style="display: block;">
                ...
                <h3>2. Cadastrar um serviço. Atente-se aos campos.</h3>
                <h3>3. Liste seus clientes e serviços.</h3>
            </div>
            <!---------------------------- CADASTRO  ---------------------------->
                                ...
                                <tr>
                                    ...
                                    <td><a href='servicos.php?id_cliente="
                                        ...
                                        if (mysqli_fetch_assoc($res) == 0) {
                                            echo "
                                            <button><a href='servicos.php?id_cliente=0&cad_cliente=0&id_servico=0'>Ir para servicos</a></button>
                                            ";
                                        }
                                    }
                                    ?>
