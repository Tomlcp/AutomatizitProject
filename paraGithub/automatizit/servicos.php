...
<body>
    ...
    <section>
        <div class="portal-menu">
            ...
            <?php
            if (isset($_GET['id_cliente']) || isset($_GET['cad_cliente']) || isset($_GET['id_servico'])) {
                $id_cliente = $_GET['id_cliente'];
                $cad_cliente = $_GET['cad_cliente'];
                $id_servico = $_GET['id_servico'];
            }
            ?>
            <h3>Id do cliente é >> <?php
                                    if (!isset($_GET['id_cliente'])) {
                                        echo "Adicione um serviço a um cliente.</h3>";
                                    } else {
                                        echo $id_cliente . "</h3>";
                                    }
                                    ?>
        ...
        <div class=" portal-display">
            ...
            <div id="inserir" class="inserir-servico" style="display: none; position: absolute; 
                ...
                <form action="./crud/inserirServico.php" method="get">
                    <?php
                    ...
                    <input type="hidden" name="cad_cliente" value="<?php
                                                                    if (isset($_GET['id_cliente'])) {
                    ...
                    <label for="nome_cliente">Digite o Nome do cliente: </label>
            ...
            <div id="editar" class="editar-servico" style="display: none;
                ...
                <form action="./crud/atualizarServico.php" method="get">
